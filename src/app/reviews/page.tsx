      ...
      <div className={`absolute left-0 top-0 bottom-0 w-72 bg-white shadow-xl transition-transform duration-300 ease-out ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="p-6">
          ...
          <nav className="space-y-4">
            ...
            <a href="/reviews" onClick={onClose} className="block text-base font-medium text-teal-800 hover:text-teal-600 transition">Reviews</a>
...
const reviews = [
  ...
  {
    name: "Lisa H.",
    text: "I was skeptical at first, but after just a few visits my chronic neck pain has improved dramatically. Dr. Bell explains everything clearly and makes you feel comfortable.",
    rating: 5,
    date: "November 2025"
  },
  {
    name: "Robert P.",
    text: "Great experience from start to finish. The $29 new patient special was a no-brainer. Now I'm on the wellness plan and feeling better than I have in years.",
    rating: 5,
    date: "November 2025"
  },
];
...
export default function ReviewsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="fixed top-0 left-0 right-0 bg-white shadow-md z-40">
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <a href="/" className="md:hidden w-20 h-10 bg-gray-100 border border-gray-300 rounded flex items-center justify-center text-xs text-gray-400">
              LOGO
            </a>
          ...
          <div className="hidden md:flex gap-8 text-gray-600 font-medium">
            ...
            <a href="/reviews" className="hover:text-teal-600 transition text-teal-600">Reviews</a>
          ...
          <a
            href="/#pricing"
            className="bg-teal-600 text-white px-4 py-2.5 rounded font-semibold hover:bg-teal-700 transition text-sm shadow-sm cursor-pointer"
          >
            View Services
          </a>
        </div>
      ...
      {/* Hero Section */}
      <section className="pt-24 pb-6 px-4 bg-gradient-to-b from-teal-50 to-white">
        <div className="max-w-4xl mx-auto">
          {/* Back Link */}
          <a href="/" className="inline-flex items-center gap-2 text-teal-600 font-medium mb-6 hover:text-teal-700 transition">
          ...
          <div className="text-center">
            <h1 className="text-3xl font-bold text-teal-800 mb-2">Patient Reviews</h1>
            <p className="text-teal-600 mb-4">See what our patients are saying about The Happy Spine Studio</p>
            
            {/* Overall Rating */}
            <div className="inline-flex items-center gap-3 bg-white rounded-xl px-5 py-3 shadow-md border border-teal-100">
      ...
      <section className="py-6 px-4">
        <div className="max-w-4xl mx-auto">
            ...
            {reviews.map((review, index) => (
              <div key={index} className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                <div className="flex items-start justify-between mb-3">
                  <div>
                    <p className="font-bold text-teal-800">{review.name}</p>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600 mb-3">Had a great experience?</p>
            <a 
              href="#" 
              className="inline-flex items-center gap-2 bg-teal-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-teal-700 transition cursor-pointer"
            >
              Leave a Review
              <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
      ...
      {/* Contact Section */}
      <section className="py-10 md:py-16 px-4 bg-gradient-to-br from-cyan-500 to-teal-600">
