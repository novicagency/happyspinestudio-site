      ...
      <div className={`absolute left-0 top-0 bottom-0 w-72 bg-white shadow-xl transition-transform duration-300 ease-out ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="p-6">
          ...
          <nav className="space-y-4">
            ...
            <a href="/reviews" onClick={onClose} className="block text-base font-medium text-[#2c5887] hover:text-[#2c5887] transition">Reviews</a>
...
export default function ReviewsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="fixed top-0 left-0 right-0 bg-white shadow-md z-40">
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="hidden lg:flex gap-8 text-gray-600 font-medium text-lg">
            ...
            <a href="/reviews" className="hover:text-[#2c5887] transition text-[#2c5887]">Reviews</a>
      ...
      {/* Hero Section */}
      <section className="pt-28 md:pt-36 pb-6 px-4 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center">
            <h1 className="text-3xl font-bold text-[#2c5887] mb-2">Patient Reviews</h1>
            <p className="text-[#2c5887] mb-4">See what our patients are saying about The Happy Spine Studio</p>
            
            {/* Overall Rating */}
            <div className="inline-flex items-center gap-3 bg-white rounded-xl px-5 py-3 shadow-md border border-[#2c5887]">
              <div className="text-3xl font-bold text-[#1e4163]">4.8</div>
      ...
      <section className="py-6 px-4">
        <div className="max-w-4xl mx-auto">
            ...
            {reviews.map((review, index) => (
              <div key={index} className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                <div className="flex items-start justify-between mb-3">
                  <div>
                    <p className="font-bold text-[#2c5887]">{review.name}</p>
          ...
          <div className="mt-8 text-center">
            ...
            <a 
              href="#" 
              className="inline-flex items-center gap-2 bg-[#2c5887] text-white px-6 py-3 rounded-xl font-semibold hover:bg-[#1e4163] transition cursor-pointer"
            >
              Leave a Review
              <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
