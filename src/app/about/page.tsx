...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="fixed top-0 left-0 right-0 bg-white shadow-md z-40">
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-8 text-gray-600 font-medium">
            <a href="/about" className="hover:text-teal-600 transition text-teal-600">About</a>
      ...
      {/* Hero Section */}
      <section className="pt-24 pb-8 px-4 bg-gradient-to-b from-teal-50 to-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            />
            <h1 className="text-3xl font-bold text-teal-800 mb-2">Dr. Jason Bell, DC</h1>
            <p className="text-teal-600 italic">"Make Your Spine Happy."</p>
          </div>
          
          {/* Quick Info */}
          <div className="flex justify-center gap-4 mb-8">
            <div className="bg-white rounded-xl px-4 py-3 shadow-md border border-teal-100 text-center">
      ...
      <section className="pt-2 pb-12 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-teal-800 mb-4">About Dr. Bell</h2>
